...
urlpatterns = [
    ...
    path('oeuvre/id/<str:id>/update_latest_comment', views.update_latest_comment, name='update_latest_comment'),
    path('oeuvre/id/<str:id>/delete_latest_comment', views.delete_latest_comment, name='delete_latest_comment'),
