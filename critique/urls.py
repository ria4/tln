...
urlpatterns = [
    ...
    path('oeuvre/addspan', views.add_oeuvrespan, name='add_oeuvrespan'),
    path('oeuvre/autocomplete-oeuvre', views.OeuvreAutocomplete.as_view(), name='autocomplete_oeuvre'),
    ...
    path('oeuvre/<slug:slug>/update_latest_oeuvrespan', views.update_latest_oeuvrespan, name='update_latest_oeuvrespan'),
    path('oeuvre/<slug:slug>/delete_latest_oeuvrespan', views.delete_latest_oeuvrespan, name='delete_latest_oeuvrespan'),
