...
from blog.markups import html_format
from blog.preview import HTMLPreview
from blog.settings import AUTO_CLOSE_COMMENTS_AFTER
from blog.settings import AUTO_CLOSE_PINGBACKS_AFTER
from blog.settings import AUTO_CLOSE_TRACKBACKS_AFTER
from blog.settings import ENTRY_CONTENT_TEMPLATES
from blog.settings import ENTRY_DETAIL_TEMPLATES
from blog.settings import PINGBACK
from blog.settings import TRACKBACK
from blog.settings import UPLOAD_TO
from blog.url_shortener import get_url_shortener
...
class RestrictedUsersEntry(models.Model):
    """
    Abstract model class to restrict the display
    of the entry on authenticated, selected users.
    """
...
class ContentTemplateEntry(models.Model):
    ...
    content_template = models.CharField(
        ...
        default='blog/_entry_detail.html',
        choices=[('blog/_entry_detail.html', _('Default template'))] +
