...
from blog.views.archives import EntryIndex, EntryYear, EntryMonth, EntryDay
from blog.views.entries import EntryDetail, entry_detail_slug
from blog.views.feeds import LastEntries
from blog.views.shortlink import EntryShortLink
