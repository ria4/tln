...
from blog.views.mixins.archives import (
    ArchiveMixin, PreviousNextPublishedMixin, RestrictedUsersMixin,
)
from blog.views.mixins.callable_queryset import CallableQuerysetMixin
from blog.views.mixins.prefetch_related import PrefetchCategoriesAuthorsMixin
...
class EntryArchiveMixin(RestrictedUsersMixin,
                        ArchiveMixin,
