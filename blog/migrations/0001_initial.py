...
import blog.models_bases.entry
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', mptt.fields.TreeForeignKey(
                    ...
                    blank=True, to='blog.Category', null=True)),
            ],
            options={
                'ordering': ['title'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(
                    ...
                    upload_to=blog.models_bases.entry.image_upload_to_dispatcher,  # noqa
                ...
                ('content_template', models.CharField(
                    ...
                    choices=[
                        ('blog/_entry_detail.html', 'Default template')] + \
                        blog.settings.ENTRY_CONTENT_TEMPLATES)),
                ('detail_template', models.CharField(
                    ...
                    choices=[
                        ...
                        blog.settings.ENTRY_DETAIL_TEMPLATES)),
                ('categories', models.ManyToManyField(
                    related_name='entries',
                    verbose_name='categories', to='blog.Category',
                    blank=True)),
                ('related', models.ManyToManyField(
                    related_name='related_rel_+',
                    verbose_name='related entries', to='blog.Entry',
                    blank=True)),
