...
def get_draft_entries(number=5,
                      template='blog/tags/entries_draft.html'):
    """
...
@register.inclusion_tag('blog/tags/dummy.html')
def get_recent_comments(number=5, template='blog/tags/comments_recent.html'):
    """
...
def get_archives_entries_tree_su_sensitive(context,
        template='blog/tags/entries_archives_tree.html'):
...
def get_tag_cloud_su_sensitive(context, steps=6, min_count=None,
                               template='blog/tags/tag_cloud.html'):
