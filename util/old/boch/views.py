...
def get_boch(req, day=None):
    ...
    subprocess.call(['/home/ria/.virtualenvs/tln/bin/scrapy runspider /home/ria/tln/boch/ent_spider.py -t json --nolog -a date=%s -o - > /home/ria/tln/static/boch/boxoffice_ch.json' % day], shell=True)
